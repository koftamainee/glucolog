...
Инс. на БЖЕ  = БЖЕ_общ * УГ / ФЧИ   // справочно, в итог НЕ входит
Коррекция    = (АГ - ЦГ) / ФЧИ
Итог         = Инс. на ХЕ + Коррекция - АИ
```

> **Важно.** «Инс. на ХЕ» и «Инс. на БЖЕ» **нельзя складывать** — это альтернативные
> способы оценки дозы. В итог входит только доза по ХЕ; «Инс. на БЖЕ» показывается
> справочной строкой. Крупная подпись в UI — **«Итоговый болюс (ХЕ)»**.
...
7. **Итоговый болюс** = Инс.ХЕ + Коррекция − АИ (крупно, выделено). Инс.БЖЕ — справочно, не суммируется.
