        ...
        Column(
            ...
            Text(
                text = "1. Установите xDrip и подключите сенсор.\n" +
                    "2. В xDrip: ⋮ → «Настройки» → раздел «Настройки интеграций с " +
                    "приложениями» → включите «Локальная трансляция данных».\n" +
                    "3. Проверьте, что «Совместимая трансляция» включена (по умолчанию так).\n" +
                    "4. «Установить получателя» = com.koftamainee.glucolog → OK. " +
                    "Без этого на Android 8+ показания не доходят.\n" +
                    "5. Для истории: включите «Веб служба xDrip» (порт 127.0.0.1:17580); " +
                    "«Открытая веб служба» — выключена, секрет не нужен.\n" +
                    "6. Нажмите «Синхронизировать». Подтянется до 1000 последних показаний " +
